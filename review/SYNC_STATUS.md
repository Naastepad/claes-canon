...
## Validation state
Pending GitHub Actions validation on the feature branch / pull request.

## Merge policy
Do not merge without explicit author instruction. Once validation passes, the branch may be marked synchronized and ready for author-approved merge.
