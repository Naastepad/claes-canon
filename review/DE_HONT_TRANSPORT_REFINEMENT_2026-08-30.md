# De Hont transport refinement — 30 August 2026

## Purpose

Concretise Aernouldt de Hont's working world without converting analogy into biography.

## What is now stronger

### 1. The missing 1589 contract conditions are a retrieval problem, not a lost-act assumption
...
- freight payer;
- Horen's remuneration / commission;
- exclusivity;
- minimum or expected quantity;
- cask ownership and return;
- leakage/spoilage allocation;
- weather/loss allocation;
- payment timing.

### 2. Delft route anatomy can be made concrete at the northern end

The Schie system had already given Delft a direct water link to Delfshaven long before 1589.

Scene-safe route anatomy:

`Delft -> Delftse Schie -> Overschie / Delfshavense Schie -> Delfshaven / Maas system -> [route-specific tidal/estuary choices remain open] -> Goes`

This is better than treating Delft as if De Hont simply departed directly onto open sea.

Do not yet hard-code the precise Maas–Zeeland channel sequence or travel time.

### 3. Physical scale can be visualised without assigning De Hont a recovered ship

RCE-sponsored archaeology provides a small Dutch cargo-vessel comparator from the correct century: Hoornse Hop wreck 30426, approximately `13 m x 4.5 m`, construction dated `1525–1600`, with evidence for a small forward cooking area.

This supports prose in which a working cargo vessel is physically intimate and utilitarian rather than a miniature ocean-going prestige ship.

It does **not** prove De Hont's dimensions, capacity, rig, crew or vessel type.

## Best-fit authoring model now
...
No new authorial plot decision is required from this refinement. It strengthens evidence boundaries and scene visualization around the already approved De Hont/Horen continuity model.
