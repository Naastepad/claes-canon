...
- break **2 medicinal drachmen good gallnuts**;
- steep in **2½ medicinal ounces clear water**;
- filter through fine linen;
- retain **2 medicinal ounces of the clearest extract**.

The aim is a tannin-rich but visually pale and particle-free extract. The reconstruction therefore favors controlled steeping and clear filtration over deliberately producing the darkest possible ordinary gall ink.

### Printing medium

To the retained **2 medicinal ounces clear gallnut extract**, dissolve:

- **1½ medicinal ounces good gum arabic**.

Workshop adjustment is empirical rather than expressed as a modern percentage:

- if the medium runs or retreats from the type, add a little gum;
- if it is too stiff to distribute and transfer cleanly, temper it with a few drops of clear water.

The printer's functional criterion is the period criterion: the medium must be sufficiently **`dick ende clemachtich`** to remain on the raised letter surfaces, but it must be laid as thinly as possible so that the dry page does not reveal a conspicuous gum film, gloss or typographic *moet*.

### Developed proof

A sacrificial proof may be developed with the working reference:
...
- 1 drachme ≈ 2.94 g;
- 2 drachmen gallnuts ≈ 5.9 g;
- 2½ medicinal ounces water ≈ 58.8 g;
- 2 medicinal ounces retained extract ≈ 47 g;
- 1½ medicinal ounces gum arabic ≈ 35.3 g;
- ½ drachme green vitriol ≈ 1.47 g;
- 4 medicinal ounces water ≈ 94 g.
...
**paper + dried gum-arabic film + gallnut polyphenols/tannins**
...
> Claes is not to use ink in the memoriaal for as long as he remains Dee's pupil.

The exact wording in prose is not fixed by canon, only the prohibition and its duration.
...
The project source record `SRC-HIST-PLANTIN-PRINT-DIALOGUES-1567-001` supports the period Antwerp printing apparatus and craft criteria: ordinary printing ink differs from writing ink; normal printer's ink is oil-based and sticky; paper, ink balls, form, tympan/frisket and hand press are described; the printer must control a medium that remains on the letters.
...
`OPEN.MATERIAL.WET_TEST.001` must determine:

- wetting/retention on clean metal type;
- transfer completeness;
- optimal gum fraction;
- dry tint and gloss;
- extent of mechanical *moet*;
- behavior on period-appropriate sized paper;
- sharpness and density after diluted green-vitriol development;
- whether recto/verso printing introduces unacceptable show-through or interaction.
